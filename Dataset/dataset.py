...
class BasicDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        img_t1 = self.transform(image=img)['image']
        img_t = self.transform2(image=img)['image']
        img_n = self.totensor(image=img_t1)['image']  
        
        return idx, img_n, img_t, img_t1, target, filename
...
class GHBR_Dataset:
    """
    Dataset class gets dataset from torchvision.datasets,
    ...
    def __init__(self,
        ...
        Args
            alg: algorithms
            name: name of dataset (oct, br35h)
    ...
    def get_dset(self):
        """
        get_dset split training samples into labeled and unlabeled samples.
